 ...
 * 
 */
package labs.modules.gen.entity;
...
public class GenTableColumn extends DataEntity<GenTableColumn> {
	...
	static String baseFields = Global.getConfig("baseFields");
	/**
	 * 是否是基类字段
	 * @return
	 */
	public Boolean getIsNotBaseField(){
		if(StringUtils.isBlank(baseFields)) baseFields = "";
		return baseFields.indexOf(getSimpleJavaField())==-1;
	}
