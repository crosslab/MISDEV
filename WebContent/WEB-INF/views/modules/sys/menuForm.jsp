...
<body>
	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="menu" name="parent.id" value="${menu.parent.id}" labelName="parent.name" labelValue="${menu.parent.name}"
					title="菜单" url="/sys/menu/treeData" extId="${menu.id}" cssClass="select-icon required"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="target" htmlEscape="false" maxlength="10" class="input"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="sort" htmlEscape="false" maxlength="50" class="required digits input"/>
