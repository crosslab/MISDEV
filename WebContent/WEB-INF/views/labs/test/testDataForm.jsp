...
<body>
	...
	<form:form id="inputForm" modelAttribute="testData"
		...
		<div class="container-fluid"> <%-- 布局容器 --%>
			<div class="row-fluid"> <%-- 第一行 --%>
				<div class="span1"><%-- 第一列 ，标签--%>
					<label>归属用户：</label>
				</div>
				<div class="span5"><%-- 第一列，输入 --%>
				...
				<div class="span1"><%-- 第二列 ，标签--%>
					<label>归属部门：</label>
				</div>
				<div class="span5"><%-- 第二列 ，输入--%>
			...
			<div class="row-fluid"><%-- 第二行 --%>
				...
				<div class="span5">
					<sys:treeselect id="area" name="area.id"
						...
						url="/sys/area/treeData" cssClass="input-small required"
						allowClear="true" notAllowSelectParent="true" />
				</div>
				<div class="span1">
					<label>名称：</label>
			...
			<div class="row-fluid"><%-- 第四行 --%>
				<div class="span1">
					<label>备注信息：</label>
                </div>
                <div class="span11">
					<form:textarea path="remarks" htmlEscape="false" rows="4"
						maxlength="255" class="input-xRxlarge " />
				</div>
			</div>
		</div>
